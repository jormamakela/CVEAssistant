...
import assistant.web_frontend.FlaskAppBase
from assistant.web_frontend.FlaskAppBase import FlaskAppBase


def arg_parser_portion():
    parser = argparse.ArgumentParser()
    parser.add_argument('--interface', dest='interface', help='TUI or GUI', default='TUI')
    parser.add_argument('--noflask', dest='noflask', help='Disable Flask', default=False)
...
def init_main_routine():
    ...
    flask_base = FlaskAppBase(log_manager)
    flask_base.prepare_flask_items()
    flask_base.go()
